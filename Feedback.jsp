...
<html>
    ...
    <body style="background-color: #d25380">
        <div>
            <h1 style="font-weight: bold; font-size: 3rem; font-family: monospace; text-align: center;">Feedback</h1>
            <span>
                <form method="POST" action="Feedback.jsp">
                   <input type="text" placeholder="&#128269;Enter name" name="tSearch" style="padding: 5px 10px;" required>
    ...
    //STEP 2: CREATING THE CONNECTION OBJECT
            ...
            if(request.getParameter("bSearch")!=null)
            {
                ...
                q = "select * from FEEDBACK where NAME=?";
            ...
            //STEP 4: CREATING THE QUERY
            q = "select * from FEEDBACK order by 1";
